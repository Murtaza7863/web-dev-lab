window.PIPELINE = [
  ...
  },
  {
    ...
    next: "Name the jobs you just did.",
  },
  {
    id: "swe",
    quest: "The jobs",
    ...
    next: "Sometimes the data lives in another program.",
  },
  {
    id: "http",
    quest: "Two programs",
    layer: "Talk",
    because:
      "A method call in one program becomes a message to another. Request and reply.",
  ...
  },
  {
    ...
    layer: "Verbs",
    because: "Four verbs on a list. Nickname: CRUD.",
  ...
  },
  {
    ...
    layer: "Ship",
    because:
      "These files, hosted. Install is extra. Not required to understand a tag.",
